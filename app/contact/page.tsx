      ...
      case 0:
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            />
            <Button type="button" onClick={nextStep} className="w-full h-12 rounded-full text-lg mt-4 bg-blue-600 hover:bg-blue-700 text-white">
        ...
        return (
          <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-300">
            ...
            <div className="flex gap-4 mt-6">
              ...
              <Button type="button" onClick={nextStep} className="w-2/3 h-12 rounded-full bg-blue-600 hover:bg-blue-700 text-white">
                Next Step <ChevronRight className="ml-2 w-4 h-4" />
              </Button>
            </div>
          </div>
