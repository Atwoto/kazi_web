        ...
        <div className="mb-24">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {t.pricing.academic.tiers.map((tier, index) => (
              <Card key={index} className="border border-gray-100 shadow-lg hover:shadow-xl transition-shadow rounded-2xl flex flex-col justify-between">
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {t.pricing.general.plans.map((plan, index) => (
              <Card key={index} className="border border-gray-100 shadow-md hover:shadow-lg transition-shadow rounded-2xl">
                <CardHeader>
