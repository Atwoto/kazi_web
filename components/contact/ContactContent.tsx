    ...
    <div className="min-h-screen bg-gray-50 pt-[72px] lg:pt-24">
      <div className="flex flex-col lg:flex-row min-h-[calc(100vh-6rem)]">
        ...
        <div className="lg:w-5/12 bg-slate-900 text-white p-8 lg:p-16 flex flex-col justify-center relative overflow-hidden order-first">
           ...
           <div className="absolute top-[-10%] left-[-10%] w-[500px] h-[500px] bg-blue-900/30 rounded-full blur-[100px] pointer-events-none z-0" />
           <div className="absolute bottom-[-10%] right-[-10%] w-[400px] h-[400px] bg-slate-700/30 rounded-full blur-[100px] pointer-events-none z-0" />
