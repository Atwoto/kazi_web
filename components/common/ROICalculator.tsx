    ...
    <Card className="w-full max-w-lg mx-auto border-blue-100 shadow-xl bg-white">
      <CardHeader className="bg-slate-50 border-b border-slate-100 pb-6">
        <div className="flex items-center gap-3 mb-2">
           ...
           <CardTitle className="text-xl font-bold text-slate-900">ROI Calculator</CardTitle>
        </div>
        <p className="text-sm text-slate-500">
          See how much revenue you're leaving on the table with a standard website.
        </p>
      </CardHeader>
      ...
      <CardContent className="space-y-6 pt-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between">
            <Label htmlFor="visitors" className="font-semibold text-slate-700">Monthly Visitors</Label>
            <span className="text-blue-600 font-bold">{visitors.toLocaleString()}</span>
          </div>
          <Slider 
            id="visitors"
            min={100} 
        ...
        <div className="space-y-3">
          <div className="flex justify-between">
            <Label htmlFor="conversion" className="font-semibold text-slate-700">Current Conversion Rate (%)</Label>
        ...
        <div className="space-y-3">
          <div className="flex justify-between">
             <Label htmlFor="value" className="font-semibold text-slate-700">Avg. Client Value (€)</Label>
          </div>
        ...
        <div className="bg-slate-900 rounded-xl p-6 text-white mt-6 relative overflow-hidden">
          ...
          <div className="relative z-10">
            <p className="text-slate-400 text-sm font-medium uppercase tracking-wider mb-1">Potential Extra Revenue</p>
            <p className="text-4xl font-bold text-green-400 mb-1">
              +€{extraRevenue.toLocaleString(undefined, { maximumFractionDigits: 0 })}
            </p>
            <p className="text-xs text-slate-500">per month with a Kazi-optimized site</p>
          </div>
        </div>
      </CardContent>
      ...
      <CardFooter className="pt-2 pb-6">
        <Button className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold h-12 rounded-full shadow-lg shadow-blue-500/20">
          Get My Growth Plan <ArrowRight className="w-4 h-4 ml-2" />
        </Button>
      </CardFooter>
    </Card>
  );
