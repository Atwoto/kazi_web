      ...
      <DialogContent className="sm:max-w-md bg-white border-none shadow-2xl">
        {!isSuccess ? (
          <>
            <DialogHeader>
              ...
              <DialogDescription className="text-center text-slate-500">
                See exactly why your competitors are ranking higher than you. No strings attached.
              </DialogDescription>
            </DialogHeader>
            <form onSubmit={handleSubmit} className="space-y-4 mt-2">
              ...
              <Button type="submit" className="w-full h-12 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-lg" disabled={isLoading}>
                {isLoading ? <Loader2 className="animate-spin w-5 h-5" /> : "Scan My Website"}
              </Button>
            </form>
          </>
        ) : (
          <div className="text-center py-8">
            ...
            <h3 className="text-xl font-bold text-slate-900 mb-2">Scanning in progress!</h3>
            <p className="text-slate-500">
              We're analyzing your site now. Expect your detailed report in your inbox within 15 minutes.
            </p>
