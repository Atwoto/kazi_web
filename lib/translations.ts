export const translations = {
  en: {
    ...
    home: {
      ...
      pricing_plans: [
        { name: "Basic", setup: "€299", monthly: "€69.99", features: ["1 Page Website (Modern)", "WhatsApp Button", "Hosting Included", "Tech Support"], highlight: false },
        { name: "Standard", setup: "€599", monthly: "€99.99", features: ["Everything in Basic", "Full Booking System", "Admin Panel", "AI Chatbot (Basic)"], highlight: true },
        { name: "Pro", setup: "€799", monthly: "€149.99", features: ["Everything in Standard", "Instagram Management (8 posts/mo)", "Unlimited Graphic Design"], highlight: false },
      ],
      trustSection: {
    ...
    forms: {
      ...
      options: {
        ...
        web: {
          ...
          initialTiers: {
            basic: "Basic Build (€299 Setup)",
            standard: "Standard Build (€599 Setup)",
            pro: "Pro Build (€799 Setup)",
          },
          maintTiers: {
            basic: "Basic Maintenance (€69.99/mo)",
            standard: "Standard Maintenance (€99.99/mo)",
            pro: "Pro Maintenance (€149.99/mo)",
          },
    ...
    portfolio: {
      ...
      items: [
        ...
        },
        {
          ...
          title: "BurgerGo",
          categoryKey: "webDev",
          imageUrl: "/samples/web/burger.jpg",
          description: "Professional e-commerce for a burger joint with 15-min pickup guarantee. Dark mode aesthetic focused on appetite appeal.",
          liveUrl: "https://burger.kaziagency.es/",
        },
        {
          id: 4,
          title: "Bella Salon & Spa",
          categoryKey: "webDev",
          imageUrl: "/samples/web/salon.jpg",
          description: "Elegant booking platform for a high-end salon. Features service menu, stylist selection, and automated appointment reminders.",
          liveUrl: "https://salon.kaziagency.es/",
        },
        {
          id: 5,
          title: "AutoService Pro",
          categoryKey: "webDev",
          imageUrl: "/samples/web/social.jpg",
          description: "Service booking platform for automotive mechanics. Schedule repairs, track status, and manage service history.",
          liveUrl: "https://service.kaziagency.es/",
        },
        {
          id: 6,
  ...
  es: {
    ...
    home: {
      ...
      pricing_plans: [
        { name: "Básico", setup: "€299", monthly: "€69.99", features: ["Web de 1 Página (Moderna)", "Botón de WhatsApp", "Hosting Incluido", "Soporte Técnico"], highlight: false },
        { name: "Estándar", setup: "€599", monthly: "€99.99", features: ["Todo lo de Básico", "Sistema de Reservas Completo", "Panel de Administración", "Chatbot IA (Básico)"], highlight: true },
        { name: "Pro", setup: "€799", monthly: "€149.99", features: ["Todo lo de Estándar", "Gestión de Instagram (8 posts/mes)", "Diseño Gráfico Ilimitado"], highlight: false },
      ],
      trustSection: {
    ...
    forms: {
      ...
      options: {
        ...
        web: {
          ...
          initialTiers: {
            basic: "Construcción Básica (€299 Setup)",
            standard: "Construcción Estándar (€599 Setup)",
            pro: "Construcción Pro (€799 Setup)",
          },
          maintTiers: {
            basic: "Mantenimiento Básico (€69.99/mes)",
            standard: "Mantenimiento Estándar (€99.99/mes)",
            pro: "Mantenimiento Pro (€149.99/mes)",
          },
    ...
    portfolio: {
      ...
      readFullStory: "Ver Caso de Estudio",
      items: [
        {
          id: 1,
          title: "Restaurante La Mesa",
        ...
        },
        {
          ...
          categoryKey: "webDev",
          imageUrl: "/samples/web/burger.jpg",
          description: "E-commerce profesional para hamburguesería con garantía de recogida en 15 min. Estética oscura enfocada en el apetito.",
          liveUrl: "https://burger.kaziagency.es/",
        },
        {
          id: 4,
          ...
          categoryKey: "webDev",
          imageUrl: "/samples/web/salon.jpg",
          description: "Plataforma de reservas elegante para salón de lujo. Incluye menú de servicios, selección de estilista y recordatorios automáticos.",
          liveUrl: "https://salon.kaziagency.es/",
        },
        {
          id: 5,
          ...
          categoryKey: "webDev",
          imageUrl: "/samples/web/social.jpg",
          description: "Plataforma de reservas para taller mecánico. Agenda reparaciones, sigue el estado y gestiona el historial.",
          liveUrl: "https://service.kaziagency.es/",
        },
        {
          id: 6,
  ...
  ca: {
    ...
    home: {
      ...
      pricing_plans: [
        { name: "Bàsic", setup: "€299", monthly: "€69.99", features: ["Web d'1 Pàgina (Moderna)", "Botó de WhatsApp", "Allotjament Inclòs", "Suport Tècnic"], highlight: false },
        { name: "Estàndard", setup: "€599", monthly: "€99.99", features: ["Tot el de Bàsic", "Sistema de Reserves Complet", "Panell d'Administració", "Xatbot IA (Bàsic)"], highlight: true },
        { name: "Pro", setup: "€799", monthly: "€149.99", features: ["Tot el d'Estàndard", "Gestió d'Instagram (8 posts/mes)", "Disseny Gràfic Il·limitat"], highlight: false },
      ],
      trustSection: {
    ...
    forms: {
      ...
      options: {
        ...
        web: {
          ...
          initialTiers: {
            basic: "Construcció Bàsica (€299 Setup)",
            standard: "Construcció Estàndard (€599 Setup)",
            pro: "Construcció Pro (€799 Setup)",
          },
          maintTiers: {
            basic: "Mantenimiento Básico (€69.99/mes)",
            standard: "Mantenimiento Estándar (€99.99/mes)",
    ...
    portfolio: {
      ...
      readFullStory: "Veure Cas d'Estudi",
      items: [
        {
          id: 1,
          title: "Restaurante La Mesa",
        ...
        },
        {
          ...
          categoryKey: "webDev",
          imageUrl: "/samples/web/burger.jpg",
          description: "E-commerce professional per a hamburgueseria amb garantia de recollida en 15 min. Estètica fosca enfocada en l'apetit.",
          liveUrl: "https://burger.kaziagency.es/",
        },
        {
          id: 4,
          ...
          categoryKey: "webDev",
          imageUrl: "/samples/web/salon.jpg",
          description: "Plataforma de reserves elegant per a saló de luxe. Inclou menú de serveis, selecció d'estilista i recordatoris automàtics.",
          liveUrl: "https://salon.kaziagency.es/",
        },
        {
          id: 5,
          ...
          categoryKey: "webDev",
          imageUrl: "/samples/web/social.jpg",
          description: "Plataforma de reserves per a taller mecànic. Agenda reparacions, segueix l'estat i gestiona l'historial.",
          liveUrl: "https://service.kaziagency.es/",
        },
        {
          id: 6,
