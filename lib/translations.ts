      ...
      options: {
        ...
        web: {
          ...
          initialTiers: {
            ...
            standard: "Standard Build (€499 Setup)",
            pro: "Pro Build (€499 Setup)",
          },
          maintTiers: {
            basic: "Basic Maintenance (€29/mo)",
            standard: "Standard Maintenance (€49/mo)",
            pro: "Pro Maintenance (€249/mo)",
          },
      ...
      options: {
        ...
        web: {
          ...
          initialTiers: {
            ...
            standard: "Construcción Estándar (€499 Setup)",
            pro: "Construcción Pro (€499 Setup)",
          },
          maintTiers: {
            basic: "Mantenimiento Básico (€29/mes)",
            standard: "Mantenimiento Estándar (€49/mes)",
            pro: "Mantenimiento Pro (€249/mes)",
          },
      ...
      options: {
        ...
        web: {
          ...
          initialTiers: {
            ...
            standard: "Construcció Estàndard (€499 Setup)",
            pro: "Construcció Pro (€499 Setup)",
          },
          maintTiers: {
            basic: "Manteniment Bàsic (€29/mes)",
            standard: "Manteniment Estàndard (€49/mes)",
            pro: "Manteniment Pro (€249/mes)",
          },
